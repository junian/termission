...
{
    /// <summary>
    /// Defines how JavaScript should be colorized using a <see cref="AppKit.TextKit.Formatter.LanguageFormatter"/>.
    /// </summary>
    public class JavaScriptDescriptor : LanguageDescriptor
    {
        ...
        public override void Define()
        {
            ...
            Keywords.Add("function", new KeywordDescriptor(KeywordType.Type, TypeColor, "When used as function declaration."));
